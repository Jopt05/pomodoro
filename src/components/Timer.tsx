...
const Timer = ({ hasStarted, onClick, timerState }: TimerProps) => {
    ...
    useEffect(() => {
        ...
        document.title = `${timerState.minutes}:${formatSeconds(timerState.seconds)} | Pomodoro App`
    }, [timerState])
    ...
    return (
        ...
        >
            ...
            >
                ...
                >
                    { timerState.minutes }:{ formatSeconds(timerState.seconds) }
                </p>
                <p
